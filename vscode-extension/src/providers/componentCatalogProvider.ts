...
export class ComponentCatalogProvider {
    async showCatalog() {
        const panel = vscode.window.createWebviewPanel(
            'revolutionaryUICatalog',
            'Revolutionary UI v2.0 - Component Catalog',
